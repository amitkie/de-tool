...
import { getDBAndSchemaTableCreationStatus, getUserAndPaymentInfo, login } from '../../service/userService'; // Ensure this path is correct
...
function* getUserInfo(action) {
  ...
  const  id  = action.payload;
    ...
    const getDBAndSchemaTableCreationStatusResponse = yield call(getDBAndSchemaTableCreationStatus, id);
    console.log(getDBAndSchemaTableCreationStatusResponse);
